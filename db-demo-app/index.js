...
// Connect to MongoDB
// mongoose.connect('mongodb://localhost:27017/kubernativtest', {
...
// mongoose.connect('mongodb://mongo:27017/kubernativtest', {
//     useNewUrlParser: true,
//     useUnifiedTopology: true,
// });

// Run with  dynamic variables
const mongoDb = `mongodb://${mongoHost}:${mongoPort}/kubernativtest`;
